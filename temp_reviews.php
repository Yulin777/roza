...
//     Prepare an insert statement
    ...
    if ($stmt = mysqli_prepare($link, $sql)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            header("location: submitted.php?msg=<h1>Vote success</h1></br><a href='reviews.php'>View your and other reviews</a> ");
        } else {
                ...
                <div class="row box-3">
                    <div class="grid_5">
                        ...
                        <form id="contact-form" class='contact-form'
                            ...
                            <fieldset <?php if (voted == 1) echo "disabled"; ?> >
                                ...
                                <div class="btn-wr">
                                    <input id="submitreview" type="submit" class="submitBtn" value="submit" name="submit" alt="submit">
                                </div>
                            </fieldset>
