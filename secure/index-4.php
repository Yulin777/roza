                ...
                <div class="row box-3">
                    <div class="grid_5">
                        ...
                        if (isset($_GET['submit'])) {
                            printf('name: %s', $_GET['name']);
                        }
                        if (isset($_POST['submit'])) {
                            printf('nameEEE: %s', $_POST['name']);
                        }
                        ?>
<form id='' class='' action="contactUs.php">
  <input type="text" name="name2" placeholder="" value=""
         data-constraints=""/>

           <input type="submit" class="btn btn-primary btn-wr" value="Submit">
    </form>

                        <form id="contact-form" class='contact-form' action="contactUs.php">
