            ...
            <nav class="nav">
                <div class="nav_title">
                    <p style="text-align: right; padding-right: 10px; color: white">
                        <?php
                        session_start();
                        if ($_SESSION['firstName'] && $_SESSION['firstName'] != "")
                ...
                <ul class="sf-menu">
                    ...
                    <li>
                        <a style="display: inline-flex;"
                            ...
                            } else echo " class=\"grey\" ";
                            ?>
                        >
                            All Users<p style="colr: grey; font-size: 14px; margin-left: 20px;"><em> (admin only)</em></p>
                            <!--only id 7-->
                        </a>
                    </li>
    ...
    <main>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="grid_6">
                        ...
                        <p class="center indents-1">Integer convallis orci vel mi nelaoreet, at ornare lorem consequat.
                            Phasellus era nisl auctor vel veliterol. sed,pharetra venenatis nulla. Vestibulum volutpat
                            turpis ut massa commodo, quis aliquam massa facilisis.Integer convallis orci vel mi
                            nelaoreet, at ornare lorem consequat. Phasellus era nisl auctor vel veliterol. sed,pharetra
                            venenatis nulla.</p>
                    </div>
                    <div class="grid_6">
                        <div class="img img__border">
        ...
        <section class="parallax parallax1" data-parallax-speed="-0.4">
            <div class="container">
                ...
                <p class="indents-2">Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era
                    nisl auctor vel veliterol. sed,pharetra venenatis nulla. Vestibulum volutpat turpis ut massa
                    ...
                    volutpat turpis ut massa commodo, quis aliquam massa facilisis. Vestibulum volutpat turpis ut massa
                    commodo, quis aliquam massa facilisis.Integer convallis orci </p>
            ...
            <div class="container">
                ...
                <div class="row row__offset-1">
                    <div class="grid_4">
                        <figure>
                            <div class="img lazy-img" style="padding-bottom: 101.0810810810811%;"><img
                                    data-src="images/cooks/page-1_img12.jpg" alt=""></div>
                            <figcaption>Nanny Gag</figcaption>
                        </figure>
                        <h3>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl </h3>
                        <p>Vestibulum volutpat turpis ut massa commodo, quis aliquam massa facilisis.Integer convallis
                            orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl auctor vel veliterol.
                            sed,pharetra venenatis nulla.</p>
                    </div>
                    <div class="grid_4">
                        <figure>
                            <div class="img lazy-img" style="padding-bottom: 101.0810810810811%;"><img
                                    data-src="images/cooks/page-1_img13.jpg" alt=""></div>
                            <figcaption>Meksi Kan</figcaption>
                        </figure>
                    ...
                    <div class="grid_4">
                        <figure>
                            <div class="img lazy-img" style="padding-bottom: 101.0810810810811%;"><img
                                    data-src="images/cooks/page-1_img14.jpg" alt=""></div>
                            <figcaption>Elisha Beth</figcaption>
                        </figure>
        ...
        <section class="well well__offset-2">
            <div class="container center">
                ...
                <p class="indents-2">Fnteger convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era
                    nisl auctor vel veliterol. sed,pharetra venenatis nulla. Vestibulum volutpat turpis ut massa
                    commodo, quis aliquam massa facilisis.Integer convallis orci vel mi nelaoreet, at ornare lorem
