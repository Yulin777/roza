...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validate password
    if (empty(trim($_POST["password"])) || !preg_match("^([1-zA-Z0-1@.\s]{1,255})$^", $_POST["password"])) {
                ...
                <div class="row box-3">
                    ...
                    <div class="preffix_1 grid_6">
                        ...
                        <address class="address-2">
                            <div class="address_container"><p>Roza Cafe. Road 9977, Qiryat Shemona, 1220800.</p></div>
                            <dl>
                                <dt>Telphone:</dt>
